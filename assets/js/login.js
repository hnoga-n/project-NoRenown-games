...
function sanitizeForm() {
	...
	if (flagName == false || flagPhone == false || flagMailExist == false || flagPw == false || flagCfmPw == false) {
		return false;
	} else {
		return true;
	}
...
function sanitizeContactForm() {
	...
	if (flagPhone == false || flagName == false || flagFeedback == false || flagMail == false || flagMailExist == false) {
		return false;
	} else {
		return true;
	}
