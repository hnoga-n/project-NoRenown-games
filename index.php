      ...
      <div class="sliders">
        <div class="slide" id="slide-first">
          <a class="slider-img" href="#"
            ><img src="./assets/img/eldenRingSlide.jpg " class="slider-img"
          /></a>
        </div>

        <div class="slide">
          <a class="slider-img" href="#"
            ><img src="./assets/img/gowSlideShow.jpg" class="slider-img"
          /></a>
        </div>

        <div class="slide">
          <a class="slider-img" href="#"
            ><img src="./assets/img/genshinsLIDEsHOW.jpg " class="slider-img"
          /></a>
        </div>
        ...
        <div class="slide">
          <a class="slider-img" href="#"
            ><img
              src="./assets/img/spongebogSlhowSlide.jpg "
              class="slider-img"
          /></a>
        </div>
      </div>
