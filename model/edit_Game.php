<?php
    ...
    $sql2 = "
                UPDATE game_detail 
                SET cfg_os='$cfg_os',cfg_processor='$cfg_processor',cfg_graphics='$cfg_graphics',cfg_storxage='$cfg_storage',about='$about',screenshot1='$scr1',screenshot2='$scr2',screenshot3='$scr3',screenshot4='$scr4',trailer='$trailer'
                WHERE gdt_id=$gid
    ";
