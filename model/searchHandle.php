...
$product_matched_search_sql = "SELECT * FROM  games WHERE visible=1 AND gname REGEXP '$param1' AND gcategory REGEXP '$param3' AND CAST(gprice as FLOAT)  BETWEEN $param4 AND $param5";

$product_of_specified_page_sql = "SELECT * FROM  games WHERE visible=1 AND gname REGEXP '$param1' AND gcategory REGEXP '$param3' AND gprice BETWEEN $param4 AND $param5 ORDER BY CAST(gprice as FLOAT) $param6 LIMIT 12 OFFSET $startPos ";
